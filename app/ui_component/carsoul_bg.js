export default function Carsoul() {
    return (
<>
    <div className="w-[95%] mt-4 ml-auto mr-auto  rounded-xl h-[300px] overflow-hidden flex bg-blend-darken" >
        ...
        <div className=" w-fit ml-auto " >
         ...
         <p className="text-lg mt-1 mb-1 h-[40px]" align="right">Score: 8.33</p>   
         <p className="text-lg mt-1 mb-1 h-[40px]" align="right">Ranked: #33</p>   
         <p className="text-lg mt-1 mb-1 h-[40px]" align="right">Members: 37,197</p>   
         <p className="text-lg mt-1 mb-1 h-[40px]" align="right">Type: Light Novel</p>   
         <p className="text-lg mt-1 mb-1 h-[40px]" align="right">Genre: Drama</p>   
